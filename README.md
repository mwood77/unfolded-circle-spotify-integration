...
### Why the fork?
This project is a disconnected fork of `uc-intg-spotify` by @mase1981. The original project was written without hardware testing or any kind of validation. This meant a number of usability regressions (bugs) entered each release. The author wasn't receptive to feedback and shadowbanned me from his repositories. Hence, this fork.
